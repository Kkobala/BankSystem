...
namespace BankSystem.Tests
{
	public class InnerTransactionTests
	{
		...
		[TestCase("ABC123", "DEF456", 100, 100)]
		[TestCase("GHI789", "JKL012", 200, 200)]
			...
			int expectedTransaction)
		{
			...
			var actualTransaction = await transactionService.InnerTransactionAsync(fromIBAN, toIBAN, amount);
